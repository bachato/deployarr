...
if [[ "$VPN_TYPE" == "wireguard" ]]; then
    ...
    f_sed_replace "# WIREGUARD_PRIVATE_KEY:" "WIREGUARD_PRIVATE_KEY:" "$COMPOSE_FILE"
    f_sed_replace "# WIREGUARD_ADDRESSES:" "WIREGUARD_ADDRESSES:" "$COMPOSE_FILE"
    echo
    ...
    f_sed_replace "# OPENVPN_USER:" "OPENVPN_USER:" "$COMPOSE_FILE"
    f_sed_replace "# OPENVPN_PASSWORD:" "OPENVPN_PASSWORD:" "$COMPOSE_FILE"
    echo
